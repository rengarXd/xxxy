...
;! function(win) {"use strict";
	...
	var initObj = {
		...
		noInputTextFormType : ["radio", "checkbox"],
		otherInputFormType : ["button", "image", "submit", "reset"],
		tagAttr : ["data-rule", "data-nullmsg", "data-errmsg", "data-sucmsg", "data-sync", "data-haved"],
		rules : {
